...
/** Open left sidebar on phone/tablet and show dim overlay (for TOC review). */
export function openLeftSidebarWithOverlay() {
  ...
  if (!isDesktop()) {
    ...
    leftToggle?.classList.add('panel-icon-active');
  }
}
